...
unsigned long smm_stack_0[STACK_SIZE / 4];
unsigned long smm_stack_1[STACK_SIZE / 4];
unsigned long smm_stack_2[STACK_SIZE / 4];
unsigned long smm_stack_3[STACK_SIZE / 4];	//HJPARK
/* 
...
unsigned long *const _smm_stack_0 = &smm_stack_0[STACK_SIZE / 4 - 1];	//hjpark
unsigned long *const _smm_stack_1 = &smm_stack_1[STACK_SIZE / 4 - 1];
unsigned long *const _smm_stack_2 = &smm_stack_2[STACK_SIZE / 4 - 1];
unsigned long *const _smm_stack_3 = &smm_stack_3[STACK_SIZE / 4 - 1];

//kwlee const unsigned long nt_start_address = 0;//normal_start_address;
...
/*   SafeGStart((unsigned long *) secure_start_address,	//kwlee
               (unsigned long *) normal_start_address);	*/
